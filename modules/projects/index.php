    ...
    <div class="container">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="status-<?php echo strtolower($project['payment_status']); ?>"><?php echo $project['payment_status']; ?></span></td>
                    <td>
                        <a href="view.php?id=<?php echo $project['id']; ?>">View</a>
                        <a href="edit.php?id=<?php echo $project['id']; ?>">Edit</a>
                        <a href="?delete=<?php echo $project['id']; ?>" onclick="return confirm('Are you sure? This will also delete associated invoices!')">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
        ...
        <div class="pagination">
            <?php for($i = 1; $i <= $total_pages; $i++): ?>
                <a href="?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&status=<?php echo urlencode($status); ?>&department=<?php echo urlencode($department); ?>&type=<?php echo urlencode($type); ?>" class="<?php echo $i == $page ? 'active' : ''; ?>">
                    <?php echo $i; ?>
                </a>
            <?php endfor; ?>
        </div>
